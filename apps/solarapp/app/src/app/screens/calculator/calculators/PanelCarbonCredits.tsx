...
import { IDevice, ISolarPanel } from '@solarapp/lib';
...
const PanelCarbonCredits = ({ navigation, route }) => {
  ...
  return (
    <LoaderWrapper isLoading={isLoading}>
      <View style={[gstyles.gap05, gstyles.pad1]}>
        ...
        />
        <TextField
          value={(device.deviceSpecs as ISolarPanel)?.powerOutput?.toString()}
          onChange={(e) => {
            try {
              setDevice({
                ...device,
        ...
        />
        <TextField
          value={(device.deviceSpecs as ISolarPanel)?.size?.toString()}
          onChange={(e) => {
            try {
              setDevice({
                ...device,
...
export default PanelCarbonCredits;
